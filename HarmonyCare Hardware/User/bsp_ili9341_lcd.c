...
extern const unsigned char gImage_666[153608] ;

extern const unsigned char gImage_1[4616];
extern const unsigned char gImage_2[4616];
extern const unsigned char gImage_3[4616];
extern const unsigned char gImage_4[4616];
extern const unsigned char gImage_5[4616];
extern const unsigned char gImage_6[4616];
extern const unsigned char gImage_7[4616];
extern const unsigned char gImage_8[4616];
extern const unsigned char gImage_9[4616];
extern const unsigned char gImage_10[4616];
extern const unsigned char gImage_11[4616];
extern const unsigned char gImage_12[4616];
extern const unsigned char gImage_13[4616];
extern const unsigned char gImage_14[4616];
extern const unsigned char gImage_15[4616];




extern const unsigned char gImage_777[28808];
extern const unsigned char gImage_888[28808];
extern const unsigned char gImage_999[28808];
//根据液晶扫描方向而变化的XY像素宽度
...
void ILI9341_ClearRegion(uint16_t usX, uint16_t usY, uint16_t width, uint16_t height)
{
...
void ILI9341_DispChar_EN ( uint16_t usX, uint16_t usY, const char cChar )
{
	...
	UsartPrintf(USART_DEBUG, "Display Char: %c at X: %d, Y: %d\n", cChar, usX, usY);
...
{
	 ILI9341_ClearRegion(usX, usY, 100, 20); // ?????????????
  ...
  uint32_t index = 0, counter = 0;
	...
	for ( index = 0; index < Font_Height; index++ )
	{
			...
			for ( counter = 0; counter < Font_width; counter++ )
			{
					...
					//整个字节值为1表示该像素为笔迹
					//整个字节值为0表示该像素为背景
				  picL = *(gImage_666 + (((usY+index)*240)+(usX+counter))* 2);	//数据低位在前
					picH = *(gImage_666 + (((usY+index)*240)+(usX+counter)) * 2 + 1);
...
void LCD_Showimage(uint16_t usX, uint16_t usY, uint16_t usWidth, uint16_t usHeight, const unsigned char *p) //显示usWidth*usHeight 图片
{
	uint32_t i = 0;
	unsigned char picH, picL;
